...
@section('title', 'Tambah Peserta Prakerin')
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <div class="premium-card p-4 shadow-lg border-0">
            <h3 class="font-title text-dark mb-4"><i class="fa-solid fa-user-plus text-primary me-2"></i>Tambah Peserta Prakerin Baru</h3>
            ...
            <form method="POST" action="{{ route('admin.prakerin.store') }}">
                @csrf
                ...
                <div class="border-bottom pb-3 mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input id="name" name="name" type="text" class="form-control rounded-3 py-2" placeholder="Nama lengkap siswa" value="{{ old('name') }}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label fw-medium text-dark">Alamat Email</label>
                            <input id="email" name="email" type="email" class="form-control rounded-3 py-2" placeholder="email@contoh.com" value="{{ old('email') }}" required>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="border-bottom pb-3 mb-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input id="nisn" name="nisn" type="text" class="form-control rounded-3 py-2" placeholder="Nomor induk siswa" value="{{ old('nisn') }}" required>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="col-md-6">
                        <label for="status" class="form-label fw-medium text-dark">Status Awal</label>
                        <select id="status" name="status" class="form-select rounded-3 py-2" required>
                            ...
                            <option value="pending" {{ old('status') == 'pending' ? 'selected' : '' }}>Menunggu Validasi (Pending)</option>
                            <option value="rejected" {{ old('status') == 'rejected' ? 'selected' : '' }}>Ditolak (Rejected)</option>
                        </select>
                        <small class="text-muted">Jika disetujui, peserta dapat langsung mengisi jurnal kegiatan harian.</small>
                    </div>
                </div>

                <button type="submit" class="btn btn-gradient-primary w-100 py-2.5 rounded-3">
                    <i class="fa-solid fa-floppy-disk me-2"></i> Simpan Data Peserta
                </button>
            </form>
        </div>
    </div>
